...
//#endregion
//#region src/renderer/src/assets/player.png
var player_default = "" + new URL("player-BfRgr89S.png", import.meta.url).href;
//#endregion
...
//#endregion
//#region src/renderer/src/AdminDashboard.tsx
...
var inputCls = "w-full bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] rounded-[8px] px-[12px] py-[8px] text-white font-ui text-[14px] tracking-[-0.3px] focus:outline-none focus:border-[rgba(0,255,225,0.4)] placeholder:text-white/25 transition-colors";
var labelCls = "font-ui text-[12px] text-white/45 tracking-[-0.2px] mb-[5px]";
function todayLabel() {
...
function AdminDashboard({ username, onNewsUpdated }) {
	...
	const [confirmRemoveAdmin, setConfirmRemoveAdmin] = (0, import_react.useState)(null);
	const fetchAll = async () => {
		setLoading(true);
		try {
			const [nr, ar] = await Promise.all([window.launcher.getNews(), window.launcher.getAdmins()]);
	...
	const saveNews = async () => {
		...
		try {
			...
			if (editingId) await window.launcher.updateNews({
				id: editingId,
				...payload
			});
			else await window.launcher.createNews(payload);
			setShowForm(false);
			setEditingId(null);
			await fetchAll();
			onNewsUpdated();
	...
	const doRemoveAdmin = async (name) => {
		await window.launcher.removeAdmin(name);
		setConfirmRemoveAdmin(null);
		await fetchAll();
	};
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "backdrop-blur-[5.95px] bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] rounded-[16px] shadow-[2px_2px_8px_0px_rgba(0,0,0,0.1)] flex flex-col h-full overflow-hidden",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex items-center justify-between px-[24px] py-[18px] border-b border-[rgba(255,255,255,0.08)] shrink-0",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
							...
							d: "M2 14.5L1 7l4.5 4L9 2l3.5 9L17 7l-1 7.5",
							stroke: "rgba(255,255,255,0.6)",
							strokeWidth: "1.4",
							strokeLinecap: "round",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "font-ui font-bold text-[18px] text-white tracking-[-0.7px]",
						children: "Administration"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "font-ui text-[12px] text-white/30 tracking-[-0.3px]",
						children: username
					})
				]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "flex gap-[3px] bg-[rgba(0,0,0,0.25)] rounded-[10px] p-[3px]",
				children: ["news", "admins"].map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					className: `font-ui text-[13px] px-[14px] py-[6px] rounded-[7px] transition-colors ${tab === t ? "bg-[rgba(255,255,255,0.12)] text-white font-semibold" : "text-white/35 hover:text-white/55"}`,
					onClick: () => {
						setTab(t);
						setShowForm(false);
						setConfirmDeleteId(null);
					...
					children: t === "news" ? "Actualités" : "Administrateurs"
				}, t))
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex-1 overflow-y-auto p-[22px] min-h-0",
			children: [tab === "news" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex flex-col gap-[14px]",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center justify-between shrink-0",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "font-ui text-[12px] text-white/35",
							children: [
								news.length,
								" actualité",
								news.length !== 1 ? "s" : "",
					...
					showForm && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "bg-[rgba(0,0,0,0.28)] border border-[rgba(255,255,255,0.1)] rounded-[12px] p-[18px] flex flex-col gap-[12px]",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center justify-between",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "font-ui font-semibold text-[14px] text-white tracking-[-0.5px]",
									children: editingId ? "Modifier l'actualité" : "Nouvelle actualité"
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: labelCls,
									children: "URL de l'image (optionnel — imgur, discord CDN…)"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									}), form.imageUrl && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "size-[36px] rounded-[6px] overflow-hidden shrink-0 border border-[rgba(255,255,255,0.12)]",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex gap-[8px] justify-end pt-[2px]",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									onClick: saveNews,
									children: saving ? "Enregistrement…" : editingId ? "Enregistrer" : "Publier →"
								})]
							})
						]
					}),
					loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "font-ui text-[13px] text-white/25 text-center py-[40px]",
						children: "Chargement…"
					}) : news.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex flex-col items-center gap-[10px] py-[56px]",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "font-ui text-[15px] text-white/20",
							children: "Aucune actualité publiée"
						...
						children: news.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "size-[50px] rounded-[6px] overflow-hidden shrink-0 bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.07)]",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "font-ui font-semibold text-[13px] text-white tracking-[-0.4px] truncate",
										children: item.title
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
										className: "font-ui text-[11px] text-white/30 mt-[2px]",
										children: [item.date, item.author ? ` · ${item.author}` : ""]
									})]
								}),
								confirmDeleteId === item.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex gap-[6px] items-center shrink-0",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "font-ui text-[12px] text-white/40",
											children: "Supprimer ?"
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									className: "flex gap-[5px] opacity-0 group-hover:opacity-100 transition-opacity shrink-0",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
											...
											fill: "none",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
												d: "M.5 3h10M3.5 3V2h4V3M4 5.5v4M7 5.5v4M1.5 3l.7 6.5a1 1 0 001 .9h4.6a1 1 0 001-.9L9.5 3",
												stroke: "currentColor",
												strokeWidth: "1.2",
												strokeLinecap: "round"
											})
			...
			}), tab === "admins" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex flex-col gap-[14px]",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "flex items-center justify-between shrink-0",
					...
					loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						className: "flex flex-col gap-[7px]",
						children: admins.map((name) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-[12px] bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.07)] rounded-[10px] p-[11px]",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "size-[40px] rounded-[6px] overflow-hidden shrink-0",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
										src: `https://mc-heads.net/avatar/${encodeURIComponent(name)}/64`,
										alt: "",
										className: "size-full object-cover",
										onError: (e) => {
											e.currentTarget.src = "" + new URL("player-BfRgr89S.png", import.meta.url).href;
										}
									})
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									className: "font-ui font-semibold text-[14px] text-white tracking-[-0.4px] flex-1",
									children: [name, name === username && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "font-normal text-[11px] text-white/30 ml-[8px]",
										children: "(vous)"
									})]
								}),
								name === username ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "font-ui text-[11px] text-white/20 px-[10px] py-[5px] rounded-[6px] border border-[rgba(255,255,255,0.06)]",
									children: "Protégé"
								}) : confirmRemoveAdmin === name ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex gap-[6px] items-center shrink-0",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "font-ui text-[12px] text-white/40",
...
//#endregion
//#region src/renderer/src/assets/news-1.png
var news_1_default = "" + new URL("news-1-2iu81UUq.png", import.meta.url).href;
//#endregion
//#region src/renderer/src/assets/news-2.png
var news_2_default = "" + new URL("news-2-DWD1DKc1.png", import.meta.url).href;
//#endregion
//#region src/renderer/src/assets/news-3.png
var news_3_default = "" + new URL("news-3-CWML4Zmf.png", import.meta.url).href;
//#endregion
//#region src/renderer/src/assets/news-4.png
var news_4_default = "" + new URL("news-4-DF2tG8dg.png", import.meta.url).href;
//#endregion
//#region src/renderer/src/assets/icon-home.svg
var icon_home_default = "data:image/svg+xml,%3csvg%20width='26'%20height='23'%20viewBox='0%200%2025.7323%2023.0847'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20id='Group%20115'%3e%3cpath%20id='Rectangle%20721'%20d='M18.3359%203.10656C18.3359%202.41696%2018.895%201.85794%2019.5845%201.85794V1.85794C20.2741%201.85794%2020.8332%202.41697%2020.8332%203.10656V6.8524H19.8123C18.9969%206.8524%2018.3359%206.19141%2018.3359%205.37603V3.10656Z'%20fill='var(--fill-0,%20white)'/%3e%3cpath%20id='Vector%2068'%20d='M11.8594%203.66835L3.50142%2011.5184C3.20431%2011.7974%203.03579%2012.1869%203.03579%2012.5945V21.6083C3.03579%2022.4237%203.69678%2023.0847%204.51216%2023.0847H8.39966C9.21504%2023.0847%209.87603%2022.4237%209.87603%2021.6083V16.4722C9.87603%2015.6568%2010.537%2014.9958%2011.3524%2014.9958H14.3812C15.1927%2014.9958%2015.8521%2015.6508%2015.8575%2016.4623L15.8921%2021.6182C15.8976%2022.4297%2016.5569%2023.0847%2017.3684%2023.0847H21.3744C22.1898%2023.0847%2022.8508%2022.4237%2022.8508%2021.6083V12.6017C22.8508%2012.1899%2022.6788%2011.7968%2022.3763%2011.5173L13.872%203.6601C13.3029%203.13431%2012.4242%203.13791%2011.8594%203.66835Z'%20fill='var(--fill-0,%20white)'/%3e%3cpath%20id='Vector%2069'%20d='M0.868605%2011.2499L11.4667%201.4191C12.2565%200.686417%2013.4772%200.68493%2014.2688%201.41568L24.8637%2011.1956'%20stroke='var(--stroke-0,%20white)'%20stroke-width='1.7372'%20stroke-linecap='round'/%3e%3c/g%3e%3c/svg%3e";
"" + new URL("neoforge-BHeBUHWn.svg", import.meta.url).href;
//#endregion
//#region src/renderer/src/assets/star-1.svg
var star_1_default = "data:image/svg+xml,%3csvg%20preserveAspectRatio='none'%20width='100%25'%20height='100%25'%20overflow='visible'%20style='display:%20block;'%20viewBox='0%200%2053.0238%2053.0238'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20id='Star%2025'%20opacity='0.7'%20filter='url(%23filter0_f_0_31)'%3e%3cpath%20d='M25.9488%201.62185C26.0491%200.979187%2026.9746%200.979183%2027.075%201.62185L30.2963%2022.2522C30.3346%2022.4971%2030.5267%2022.6892%2030.7715%2022.7274L51.4019%2025.9488C52.0446%2026.0491%2052.0446%2026.9746%2051.4019%2027.075L30.7715%2030.2963C30.5267%2030.3346%2030.3346%2030.5267%2030.2963%2030.7715L27.075%2051.4019C26.9746%2052.0446%2026.0491%2052.0446%2025.9488%2051.4019L22.7274%2030.7715C22.6892%2030.5267%2022.4971%2030.3346%2022.2522%2030.2963L1.62185%2027.075C0.979187%2026.9746%200.979183%2026.0491%201.62185%2025.9488L22.2522%2022.7274C22.4971%2022.6892%2022.6892%2022.4971%2022.7274%2022.2522L25.9488%201.62185Z'%20fill='var(--fill-0,%20white)'/%3e%3c/g%3e%3cdefs%3e%3cfilter%20id='filter0_f_0_31'%20x='1.19209e-07'%20y='1.19209e-07'%20width='53.0238'%20height='53.0238'%20filterUnits='userSpaceOnUse'%20color-interpolation-filters='sRGB'%3e%3cfeFlood%20flood-opacity='0'%20result='BackgroundImageFix'/%3e%3cfeBlend%20mode='normal'%20in='SourceGraphic'%20in2='BackgroundImageFix'%20result='shape'/%3e%3cfeGaussianBlur%20stdDeviation='0.569926'%20result='effect1_foregroundBlur_0_31'/%3e%3c/filter%3e%3c/defs%3e%3c/svg%3e";
//#endregion
//#region src/renderer/src/assets/star-2.svg
var star_2_default = "data:image/svg+xml,%3csvg%20preserveAspectRatio='none'%20width='100%25'%20height='100%25'%20overflow='visible'%20style='display:%20block;'%20viewBox='0%200%2030.4215%2030.4215'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20id='Star%2025'%20opacity='0.7'%20filter='url(%23filter0_f_0_32)'%3e%3cpath%20d='M14.8877%200.930512C14.9453%200.561792%2015.4763%200.56179%2015.5338%200.930509L17.382%2012.7669C17.404%2012.9073%2017.5142%2013.0176%2017.6547%2013.0395L29.491%2014.8877C29.8597%2014.9453%2029.8597%2015.4763%2029.491%2015.5338L17.6547%2017.382C17.5142%2017.404%2017.404%2017.5142%2017.382%2017.6547L15.5338%2029.491C15.4763%2029.8597%2014.9453%2029.8597%2014.8877%2029.491L13.0395%2017.6547C13.0176%2017.5142%2012.9073%2017.404%2012.7669%2017.382L0.930512%2015.5338C0.561792%2015.4763%200.56179%2014.9453%200.930509%2014.8877L12.7669%2013.0395C12.9073%2013.0176%2013.0176%2012.9073%2013.0395%2012.7669L14.8877%200.930512Z'%20fill='var(--fill-0,%20white)'/%3e%3c/g%3e%3cdefs%3e%3cfilter%20id='filter0_f_0_32'%20x='0'%20y='0'%20width='30.4215'%20height='30.4215'%20filterUnits='userSpaceOnUse'%20color-interpolation-filters='sRGB'%3e%3cfeFlood%20flood-opacity='0'%20result='BackgroundImageFix'/%3e%3cfeBlend%20mode='normal'%20in='SourceGraphic'%20in2='BackgroundImageFix'%20result='shape'/%3e%3cfeGaussianBlur%20stdDeviation='0.326986'%20result='effect1_foregroundBlur_0_32'/%3e%3c/filter%3e%3c/defs%3e%3c/svg%3e";
//#endregion
//#region src/renderer/src/assets/star-3.svg
var star_3_default = "data:image/svg+xml,%3csvg%20preserveAspectRatio='none'%20width='100%25'%20height='100%25'%20overflow='visible'%20style='display:%20block;'%20viewBox='0%200%2043.3216%2043.3216'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20id='Star%2025'%20opacity='0.7'%20filter='url(%23filter0_f_0_58)'%3e%3cpath%20d='M21.2007%201.32509C21.2827%200.800016%2022.0389%200.800017%2022.1209%201.32509L24.7528%2018.1806C24.784%2018.3806%2024.941%2018.5376%2025.141%2018.5688L41.9965%2021.2007C42.5216%2021.2827%2042.5216%2022.0389%2041.9965%2022.1209L25.141%2024.7528C24.941%2024.784%2024.784%2024.941%2024.7528%2025.141L22.1209%2041.9965C22.0389%2042.5216%2021.2827%2042.5216%2021.2007%2041.9965L18.5688%2025.141C18.5376%2024.941%2018.3806%2024.784%2018.1806%2024.7528L1.32509%2022.1209C0.800016%2022.0389%200.800017%2021.2827%201.32509%2021.2007L18.1806%2018.5688C18.3806%2018.5376%2018.5376%2018.3806%2018.5688%2018.1806L21.2007%201.32509Z'%20fill='var(--fill-0,%20white)'/%3e%3c/g%3e%3cdefs%3e%3cfilter%20id='filter0_f_0_58'%20x='-5.96046e-08'%20y='-5.96046e-08'%20width='43.3216'%20height='43.3216'%20filterUnits='userSpaceOnUse'%20color-interpolation-filters='sRGB'%3e%3cfeFlood%20flood-opacity='0'%20result='BackgroundImageFix'/%3e%3cfeBlend%20mode='normal'%20in='SourceGraphic'%20in2='BackgroundImageFix'%20result='shape'/%3e%3cfeGaussianBlur%20stdDeviation='0.465642'%20result='effect1_foregroundBlur_0_58'/%3e%3c/filter%3e%3c/defs%3e%3c/svg%3e";
//#endregion
//#region src/renderer/src/assets/star-4.svg
var star_4_default = "data:image/svg+xml,%3csvg%20preserveAspectRatio='none'%20width='100%25'%20height='100%25'%20overflow='visible'%20style='display:%20block;'%20viewBox='0%200%2074.429%2074.429'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20id='Star%2025'%20opacity='0.7'%20filter='url(%23filter0_f_0_20)'%3e%3cpath%20d='M36.4241%202.27658C36.5649%201.37447%2037.8641%201.37447%2038.0049%202.27658L42.5267%2031.2353C42.5804%2031.579%2042.85%2031.8486%2043.1937%2031.9023L72.1524%2036.4241C73.0545%2036.5649%2073.0545%2037.8641%2072.1524%2038.0049L43.1937%2042.5267C42.85%2042.5804%2042.5804%2042.85%2042.5267%2043.1937L38.0049%2072.1524C37.8641%2073.0545%2036.5649%2073.0545%2036.4241%2072.1524L31.9023%2043.1937C31.8486%2042.85%2031.579%2042.5804%2031.2353%2042.5267L2.27658%2038.0049C1.37447%2037.8641%201.37447%2036.5649%202.27658%2036.4241L31.2353%2031.9023C31.579%2031.8486%2031.8486%2031.579%2031.9023%2031.2353L36.4241%202.27658Z'%20fill='var(--fill-0,%20white)'/%3e%3c/g%3e%3cdefs%3e%3cfilter%20id='filter0_f_0_20'%20x='-1.19209e-07'%20y='-1.19209e-07'%20width='74.429'%20height='74.429'%20filterUnits='userSpaceOnUse'%20color-interpolation-filters='sRGB'%3e%3cfeFlood%20flood-opacity='0'%20result='BackgroundImageFix'/%3e%3cfeBlend%20mode='normal'%20in='SourceGraphic'%20in2='BackgroundImageFix'%20result='shape'/%3e%3cfeGaussianBlur%20stdDeviation='0.8'%20result='effect1_foregroundBlur_0_20'/%3e%3c/filter%3e%3c/defs%3e%3c/svg%3e";
//#endregion
//#region src/renderer/src/assets/shop-1.png
var shop_1_default = "data:image/png;base64,";
//#endregion
//#region src/renderer/src/assets/shop-2.png
var shop_2_default = "data:image/png;base64,";
//#endregion
//#region src/renderer/src/assets/shop-3.png
var shop_3_default = "data:image/png;base64,";
//#endregion
//#region src/renderer/src/assets/shop-4.png
var shop_4_default = "data:image/png;base64,";
//#endregion
//#region src/renderer/src/assets/currency.png
var currency_default = "" + new URL("currency-Ubu4XdIk.png", import.meta.url).href;
//#endregion
...
var pill = "backdrop-blur-[5.95px] bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] flex items-center overflow-hidden rounded-full shadow-[2px_2px_8px_0px_rgba(0,0,0,0.1)]";
var iconBtn = "backdrop-blur-[5.95px] bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] flex items-center justify-center rounded-full shadow-[1px_1px_6px_0px_rgba(0,0,0,0.2)] size-[48px] shrink-0 transition-colors duration-150 hover:bg-[rgba(255,255,255,0.12)] active:bg-[rgba(255,255,255,0.2)]";
var greenDot = "bg-[rgba(0,255,9,0.36)] rounded-full shadow-[0px_0px_8.6px_0px_rgba(9,255,54,0.4)] size-[8px] shrink-0";
var redDot = "bg-[rgba(255,60,60,0.55)] rounded-full shadow-[0px_0px_8.6px_0px_rgba(255,60,60,0.45)] size-[8px] shrink-0";
function App() {
	const [phase, setPhase] = (0, import_react.useState)("loading");
	const [username, setUsername] = (0, import_react.useState)("");
	const [status, setStatus] = (0, import_react.useState)("Chargement...");
	const [progress, setProgress] = (0, import_react.useState)(null);
	const [activeTab, setActiveTab] = (0, import_react.useState)("home");
	const [uuid, setUuid] = (0, import_react.useState)(null);
	const [serverStatus, setServerStatus] = (0, import_react.useState)({
		online: 0,
		max: 0,
		players: [],
		loading: true
	});
	const [profileMenuOpen, setProfileMenuOpen] = (0, import_react.useState)(false);
	const [playerStatus, setPlayerStatus] = (0, import_react.useState)("online");
	const profileMenuRef = (0, import_react.useRef)(null);
	const [selectedNews, setSelectedNews] = (0, import_react.useState)(null);
	const [newsClosing, setNewsClosing] = (0, import_react.useState)(false);
	const [isAdmin, setIsAdmin] = (0, import_react.useState)(false);
	const [dynamicNews, setDynamicNews] = (0, import_react.useState)([]);
	const fetchNews = (0, import_react.useCallback)(async () => {
		const result = await window.launcher.getNews();
		if (result.success && result.news.length > 0) setDynamicNews(result.news);
	}, []);
	const checkAndInstall = (0, import_react.useCallback)(async () => {
		setPhase("checking");
		...
		if (!check.missingMods && !check.needsNeoForge) {
			...
			setPhase("installing");
			setStatus(check.needsNeoForge ? `Installation de NeoForge + ${check.missingMods} mod(s)...` : `${check.missingMods} mod(s) à télécharger...`);
	...
	(0, import_react.useEffect)(() => {
		window.launcher.onInstallProgress((data) => {
			...
			if (data.done) {
				setProgress(null);
				setStatus(`Prêt — ${modpack_default.mods.length} mods installés`);
				setPhase("ready");
				return;
			}
			if (data.step === "java" || data.step === "neoforge") setProgress({
				percent: data.percent ?? 0,
				label: data.step === "java" ? "Java 21" : "NeoForge",
				detail: data.name ?? ""
			});
			else setProgress({
				percent: data.percent ?? 0,
				label: `${data.current ?? 0} / ${data.total ?? 0}`,
				detail: data.name ?? ""
			});
		});
		window.launcher.onLaunchProgress((data) => {
			if (data.total) setProgress({
				percent: Math.round(data.task / data.total * 100),
				label: data.type ?? "",
				detail: "Téléchargement de Minecraft..."
			});
		});
		...
		(async () => {
			const session = await window.launcher.getSession();
			if (session.logged && session.username) {
				setUsername(session.username);
				if (session.uuid) setUuid(session.uuid);
				const [adminResult] = await Promise.all([window.launcher.checkAdmin(), fetchNews()]);
	...
	(0, import_react.useEffect)(() => {
		const fetchStatus = async () => {
			setServerStatus({
				...await window.launcher.getServerStatus(),
				loading: false
			});
		};
		fetchStatus();
		const id = setInterval(fetchStatus, 3e4);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-[#0e0b16]" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "absolute inset-0",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "relative z-10 flex flex-col h-full px-[32px] py-[16px] gap-[32px]",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center justify-between shrink-0",
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: `${pill} h-[35px] px-[16px] py-[8px]`,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "font-ui font-semibold text-[16px] text-white tracking-[-0.64px] whitespace-nowrap",
								children: "Zig Launcher"
							})
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: `${pill} h-[35px] gap-[8px] px-[16px] py-[8px]`,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: greenDot }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "font-ui font-semibold text-[16px] text-white tracking-[-0.64px] whitespace-nowrap",
								children: onlineLabel
							})]
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex gap-[16px] items-center",
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "size-[25px] rounded-[4px] overflow-hidden shrink-0",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
												alt: "",
												className: "w-full h-full object-cover pointer-events-none",
												src: username ? `https://mc-heads.net/avatar/${encodeURIComponent(username)}/64` : player_default,
												onError: (e) => {
													e.currentTarget.src = player_default;
												}
											})
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "font-ui font-semibold text-[16px] text-white tracking-[-0.64px] whitespace-nowrap",
											children: username || "Joueur"
										}),
										username && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: playerStatus === "dnd" ? redDot : greenDot })
									]
								}), profileMenuOpen && username && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex items-center gap-[10px] px-[14px] py-[12px] border-b border-[rgba(255,255,255,0.08)]",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "size-[32px] relative rounded shrink-0",
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
													alt: "",
													className: "absolute inset-0 max-w-none object-cover pointer-events-none rounded size-full",
													src: username ? `https://mc-heads.net/avatar/${encodeURIComponent(username)}/64` : "" + new URL("player-BfRgr89S.png", import.meta.url).href,
													onError: (e) => {
														e.currentTarget.src = "" + new URL("player-BfRgr89S.png", import.meta.url).href;
													}
												})
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "font-ui font-semibold text-[14px] text-white tracking-[-0.56px]",
												children: username
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "font-ui text-[12px] text-white/40",
												children: "Compte Minecraft"
											})] })]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "px-[8px] py-[8px] flex flex-col gap-[2px]",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												...
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: greenDot }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
														className: "font-ui text-[14px] text-white",
														children: "En ligne"
													}),
													playerStatus === "online" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
												...
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: redDot }),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
														className: "font-ui text-[14px] text-white",
														children: "Ne pas déranger"
													}),
													playerStatus === "dnd" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
														className: "ml-auto shrink-0",
														width: "13",
														height: "13",
														viewBox: "0 0 13 13",
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mx-[8px] border-t border-[rgba(255,255,255,0.08)]" }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "px-[8px] py-[8px] flex flex-col gap-[2px]",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
												...
												onClick: () => {
													...
													window.launcher.openExternal("https://www.minecraft.net/en-us/msaprofile/mygames/editprofile");
												},
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", {
														...
														d: "M2.5 13.5C3.2 11.2 5.3 9.8 8 9.8s4.8 1.4 5.5 3.7",
														stroke: "rgba(255,255,255,0.55)",
														strokeWidth: "1.3",
														strokeLinecap: "round"
													})]
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
													...
													children: [
														...
														/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
															d: "M6.5 2.5H3.5A1 1 0 002.5 3.5v9a1 1 0 001 1h3",
															stroke: "rgba(255,100,100,0.8)",
															strokeWidth: "1.3",
															strokeLinecap: "round"
														})
													...
													className: "font-ui text-[14px] text-[rgba(255,120,120,0.9)]",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
									...
									strokeWidth: "1.5",
									strokeLinecap: "round",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M1 1L11 11M11 1L1 11" })
								})
							})
						]
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex gap-[16px] flex-1 min-h-0",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
							className: "backdrop-blur-[5.95px] bg-[rgba(0,0,0,0.05)] border border-[rgba(255,255,255,0.1)] flex flex-col h-full items-center justify-between overflow-clip px-[24px] py-[32px] rounded-[16px] shadow-[2px_2px_8px_0px_rgba(0,0,0,0.1)] shrink-0",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
											alt: "",
											className: "icon-home size-[22px] object-contain shrink-0",
											src: icon_home_default
										})
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
											...
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", {
													className: "sp-finance-bar sp-finance-bar--1",
													x: "0",
													y: "114.726",
													width: "40.0632",
													height: "58.2737",
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", {
													className: "sp-finance-bar sp-finance-bar--2",
													x: "45.5264",
													y: "0",
													width: "40.0632",
													height: "173",
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", {
													className: "sp-finance-bar sp-finance-bar--3",
													x: "91.0527",
													y: "61.916",
													width: "40.0632",
													height: "111.084",
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
												className: "sp-mktg-body",
												viewBox: "0 0 166.099 181",
												fill: "none",
												overflow: "visible",
												style: {
													position: "absolute",
												...
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
														d: "M57.9131 107.025V161.698C57.9131 170.425 50.839 177.5 42.1123 177.5C33.3855 177.5 26.3105 170.425 26.3105 161.698V107.025H57.9131Z",
														fill: "white",
														stroke: "white",
														strokeWidth: "7"
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
														d: "M21.6406 42.688H71.9512V107.044H21.6406C11.6219 107.044 3.50011 98.9226 3.5 88.9038V60.8286C3.50017 50.8099 11.6219 42.6882 21.6406 42.688Z",
														fill: "white",
														stroke: "white",
														strokeWidth: "7"
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
														d: "M152.55 4.81071L76.5145 41.21C74.0774 42.3766 72.5264 44.8387 72.5264 47.5406V102.621C72.5264 105.21 73.9519 107.589 76.2352 108.81L152.271 149.472C156.946 151.973 162.599 148.585 162.599 143.283V11.1414C162.599 5.97637 157.209 2.58052 152.55 4.81071Z",
														fill: "white",
														stroke: "white",
														strokeWidth: "7"
													})
												...
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("line", {
														className: "sp-mktg-wave sp-mktg-wave--1",
														x1: "8",
														y1: "22",
														x2: "30",
														y2: "10",
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("line", {
														className: "sp-mktg-wave sp-mktg-wave--2",
														x1: "8",
														y1: "55",
														x2: "34",
														y2: "55",
													...
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)("line", {
														className: "sp-mktg-wave sp-mktg-wave--3",
														x1: "8",
														y1: "88",
														x2: "30",
														y2: "100",
									...
									isAdmin && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
												...
												d: "M2.5 14.5L1.5 7.5l4.5 3.5L10 1.5l4 9.5 4.5-3.5-1 7",
												stroke: "white",
												strokeWidth: "1.5",
												strokeLinecap: "round",
												strokeLinejoin: "round",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
							className: `flex flex-col gap-[16px] flex-1 min-h-0 min-w-0 relative ${activeTab === "admin" ? "hidden" : ""}`,
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "relative overflow-hidden border border-[rgba(255,255,255,0.1)] flex flex-col gap-[22px] items-center justify-center px-[24px] py-[32px] rounded-[16px] shadow-[0px_0px_122.6px_0px_rgba(0,255,225,0.2)] shrink-0",
									style: {
										height: 334,
										cursor: phase === "ready" ? "pointer" : "default"
									},
									onClick: phase === "ready" ? handlePlay : void 0,
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "absolute backdrop-blur-[5.95px] inset-0 pointer-events-none rounded-[16px]",
											style: { background: "linear-gradient(90deg, rgba(2,91,97,0.7) 0%, rgba(58,45,11,0.7) 100%)" }
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_0px_35.3px_0px_rgba(255,255,255,0.25)]" }),
										(phase === "loading" || phase === "checking") && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "relative z-10 font-ui text-white/50 text-[18px]",
											children: "Chargement..."
										}),
										phase === "logged-out" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "relative z-10 font-minecraft leading-[normal] tracking-[-2px] whitespace-pre uppercase text-white",
											style: { fontSize: 48 },
											children: `rejoindre zig city  !`
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											...
											children: "Se connecter avec Microsoft"
										})] }),
										phase === "installing" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "relative z-10 font-minecraft leading-[normal] tracking-[-2px] whitespace-pre uppercase text-white",
											style: { fontSize: 48 },
											children: `rejoindre zig city  !`
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "relative z-10 flex flex-col items-center gap-[8px]",
											style: { width: 600 },
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
												className: "font-ui text-white/60 text-[13px] text-center truncate w-full",
												children: [progress?.detail ?? status, progress ? ` — ${progress.label}` : ""]
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "w-full h-[3px] bg-[rgba(255,255,255,0.1)] rounded-full overflow-hidden",
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										(phase === "ready" || phase === "launching") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
											className: "relative z-10 font-minecraft leading-[normal] tracking-[-2px] whitespace-pre uppercase text-white",
											style: { fontSize: 48 },
											children: phase === "launching" ? `lancement...         ` : `rejoindre zig city  !`
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "relative z-10 flex gap-[8px] items-center",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													className: "font-minecraft text-[16px] text-white tracking-[-0.64px] whitespace-nowrap",
													children: "Zig Launcher"
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													className: "font-minecraft text-[16px] text-white tracking-[-0.64px] whitespace-nowrap",
													children: "in 1.21.1 with"
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
													alt: "",
													className: "h-[18px] w-auto shrink-0",
													src: "" + new URL("neoforge-BHeBUHWn.svg", import.meta.url).href
												}),
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
													className: "font-minecraft text-[16px] text-white tracking-[-0.64px] whitespace-nowrap",
													children: ["Neoforge - ", modpack_default.loaderVersion]
												})
											]
										})] }),
										phase === "error" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "relative z-10 font-minecraft leading-[normal] tracking-[-2px] whitespace-pre uppercase text-white",
												style: {
													fontSize: 72,
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "relative z-10 font-ui text-white/60 text-[14px] text-center max-w-[600px]",
												children: status
											}),
											username && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
												...
												children: "Réessayer l'installation"
											}),
											!username && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: [...Array.from({ length: 12 }), ...Array.from({ length: 12 })].map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: "size-[48px] rounded-[8px] shrink-0 overflow-hidden",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "backdrop-blur-[5.95px] bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] flex flex-col gap-[16px] items-start overflow-x-clip overflow-y-auto p-[16px] rounded-[16px] shadow-[2px_2px_8px_0px_rgba(0,0,0,0.1)] w-full flex-1 min-h-0",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "font-ui font-bold text-[20px] text-white tracking-[-0.8px] whitespace-nowrap shrink-0",
										children: "Nouveautées"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "grid grid-cols-2 gap-[16px] w-full shrink-0",
										children: (dynamicNews.length > 0 ? dynamicNews : NEWS_ITEMS).map((item, i) => {
											...
											return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [imgSrc ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
														className: "font-ui font-semibold text-[13px] text-white leading-tight tracking-[-0.4px]",
														children: item.title
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
														className: "font-ui text-[11px] text-white/45 mt-[3px]",
														children: item.date
													})]
												})]
											}, item.id ?? i);
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
							className: "flex flex-col gap-[16px] h-full shrink-0",
							style: { width: 304 },
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "backdrop-blur-[5.95px] bg-[rgba(0,0,0,0.05)] border border-[rgba(255,255,255,0.1)] flex flex-col gap-[22px] items-start overflow-x-clip overflow-y-auto p-[16px] rounded-[16px] shadow-[2px_2px_8px_0px_rgba(0,0,0,0.1)] w-full flex-1 min-h-0",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex flex-col gap-[8px] items-start w-full shrink-0",
										style: { width: 272 },
										children: [
											serverStatus.players.map((player, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
														className: "font-mono font-semibold text-[16px] text-white tracking-[-0.64px]",
														children: player.name
													}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
														className: "font-mono font-bold text-[14px] text-[rgba(255,255,255,0.5)] tracking-[-0.56px] whitespace-nowrap",
														children: ["En ligne depuis ", formatSince(player.since)]
													})]
												})]
											}, player.name)),
											!serverStatus.loading && serverStatus.players.length === 0 && serverStatus.online > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
												className: "font-mono text-[13px] text-white/30",
												children: [serverStatus.online, " joueur(s) en ligne"]
											}),
											!serverStatus.loading && serverStatus.online === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "font-mono text-[13px] text-white/30",
												children: serverStatus.error ? "Serveur hors ligne" : "Aucun joueur en ligne"
											})
										]
									}),
									username && (phase === "ready" || phase === "error") && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										className: "mt-auto font-ui text-[11px] text-white/20 hover:text-white/40 transition-colors",
										onClick: handleLogout,
										children: "Déconnexion"
									}),
									isBusy && phase !== "launching" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex items-center gap-[8px] text-white/30 font-ui text-[12px] mt-auto",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
								...
								className: "backdrop-blur-[5.95px] bg-[rgba(0,0,0,0.05)] border border-[rgba(255,255,255,0.1)] flex flex-col gap-[22px] items-start overflow-clip p-[16px] rounded-[16px] shadow-[2px_2px_8px_0px_rgba(0,0,0,0.1)] w-full flex-1 min-h-0",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex items-center justify-between w-full shrink-0",
									style: { height: 20 },
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "font-ui font-semibold text-[16px] text-white tracking-[-0.64px] whitespace-nowrap",
										children: "Shop du jour"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: greenDot })]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "flex flex-col gap-[8px] items-start w-full shrink-0",
									style: { width: 272 },
									children: SHOP_ITEMS.map((trade, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
													...
													className: "relative z-10 font-minecraft text-[16px] text-white tracking-[-0.64px] whitespace-nowrap",
													children: trade.fromQty
												})]
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												...
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
													...
													fill: "none",
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
														d: "M0.5 7H17.5M17.5 7L11.5 1M17.5 7L11.5 13",
														stroke: "white",
														strokeWidth: "1.5",
														strokeLinecap: "round",
														strokeLinejoin: "round"
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
													...
													children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
														alt: "",
														className: "absolute inset-0 max-w-none object-cover pointer-events-none size-full",
														src: currency_default
													})
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													className: "relative z-10 font-minecraft text-[16px] text-white tracking-[-0.64px] whitespace-nowrap",
													children: trade.toQty
												})]
											})
										]
									}, i))
			...
			selectedNews !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				onClick: closeNews,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: `relative flex flex-col rounded-[20px] overflow-hidden border border-[rgba(255,255,255,0.12)] shadow-[0px_0px_80px_rgba(0,255,225,0.12)] ${newsClosing ? "modal-card-exit" : "modal-card-enter"}`,
					style: {
						width: 680,
						maxHeight: "78vh",
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						style: { height: 320 },
						children: [
							selectedNews.img || selectedNews.imageUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								alt: "",
								className: "absolute inset-0 max-w-none object-cover size-full",
								src: selectedNews.img ?? selectedNews.imageUrl
							}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "absolute inset-0",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
									...
									className: "font-ui font-semibold text-[13px] text-white tracking-[-0.4px]",
									children: "Retour"
								})]
							})
						]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex flex-col gap-[12px] p-[28px] overflow-y-auto",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-start justify-between gap-[16px]",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "font-ui font-bold text-[21px] text-white tracking-[-0.84px] leading-tight",
								children: selectedNews.title
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "font-ui text-[12px] text-white/35 tracking-[-0.3px] whitespace-nowrap mt-[4px]",
								children: selectedNews.date
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "font-ui text-[14px] text-white/70 leading-[1.7] tracking-[-0.28px]",
							children: selectedNews.body
						})]
					})]
				})
			})
