package net.bogismok.thedirtystuff.screen.custom;
...
public class DryingRackMenu extends AbstractContainerMenu {
    ...
    public DryingRackMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }


    public DryingRackMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.DRYING_RACK_MENU.get(), pContainerId);
        blockEntity = ((DryingRackBlockEntity) entity);
        ...
        IItemHandler itemHandler = blockEntity.itemHandler;
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.DRYING_RACK.get());
    }
