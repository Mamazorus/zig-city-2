...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(Registries.BLOCK, TheDirtyStuff.MOD_ID);

    //blocks
    public static final DeferredHolder<Block, DryingRackBlock> DRYING_RACK = registerBlock("drying_rack",
            () -> new DryingRackBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS).noOcclusion().strength(1.0F, 1.0F).randomTicks()));

    //item blocks
    public static final DeferredHolder<Block, TobaccoBlock> TOBACCO = BLOCKS.register("tobacco",
            () -> new TobaccoBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHEAT)));
    public static final DeferredHolder<Block, TobaccoLeavesPalletBlock> TOBACCO_LEAVES_PALLET = BLOCKS.register("tobacco_leaves_pallet",
            () -> new TobaccoLeavesPalletBlock(BlockBehaviour.Properties.of().noOcclusion()));
    public static final DeferredHolder<Block, DriedTobaccoLeavesPalletBlock> DRIED_TOBACCO_LEAVES_PALLET = BLOCKS.register("dried_tobacco_leaves_pallet",
